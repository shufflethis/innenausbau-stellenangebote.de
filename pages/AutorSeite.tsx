  ...
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        '@type': 'Person',
        name: 'Thomas Sander',
        url: 'https://innenausbau-stellenangebote.de/autor/thomas-sander',
        jobTitle: 'Gründer & Geschäftsführer',
        worksFor: {
          '@type': 'Organization',
          name: 'Social Media Venture GmbH',
          url: 'https://innenausbau-stellenangebote.de',
          address: {
            '@type': 'PostalAddress',
        ...
        knowsAbout: ['HR-Tech', 'Recruiting', 'Jobportale', 'Innenausbau', 'Personalwesen'],
            ...
            <div className="p-8 md:p-12 space-y-10">
              ...
              <section>
                ...
                <div className="text-slate-600 leading-relaxed space-y-4">
                  ...
                  <p>
                    Unter seiner Leitung ist innenausbau-stellenangebote.de zu einer führenden Anlaufstelle für Innenausbau-Stellenangebote in Deutschland, Österreich und der Schweiz geworden.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    { title: 'Innenausbau-Branche', desc: 'Branchenspezifisches Know-how und Netzwerk im Innenausbau-Bereich' },
